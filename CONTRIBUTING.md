# Contributing to Scala FP G8

Thank you for considering contributing to Scala FP Template! We welcome contributions from the community to improve this project. Below are some guidelines to help you get started.
...
```sh
git clone https://github.com/your-username/fp4s.g8.git
cd fp4s.g8
```
...
Thank you for contributing to Scala FP Template! Your help is greatly appreciated.