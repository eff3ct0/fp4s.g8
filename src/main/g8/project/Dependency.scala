...
object Dependency {
  ...
  object logback {
    lazy val logbackClassic: ModuleID = "ch.qos.logback" % "logback-classic" % Version.LogbackVersion % Runtime
    ,
  }
  ...
  object Testing {
    ...
    ,
    lazy val munitCatsEffect: ModuleID = "org.typelevel" %% "munit-cats-effect" % MunitCatsEffectVersion % Test
    ,
