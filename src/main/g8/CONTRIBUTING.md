# Contributing to $name;format="Camel"$

Thank you for considering contributing to $name;format="Camel"$! We welcome contributions from the community to improve this project. Below are some guidelines to help you get started.
...
```sh
git clone https://github.com/your-username/$name;format="normalize"$ .git
cd $name;format="normalize"$ 
```
...
Thank you for contributing to $name;format="Camel"$! Your help is greatly appreciated.